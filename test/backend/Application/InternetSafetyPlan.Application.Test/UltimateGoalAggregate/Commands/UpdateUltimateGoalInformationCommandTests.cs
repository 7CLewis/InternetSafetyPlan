...
public class UpdateUltimateGoalInformationCommandTests
{
    [Fact]
    public async Task UpdateUltimateGoalInformation_ValidData_ReturnsSuccessfulResult()
    {
        // Arrange
        ...
        var command = new UpdateUltimateGoalInformationCommand(fakeUltimateGoalId, random.String());
        var handler = new UpdateUltimateGoalInformationCommandHandler(context);
    ...
    [Fact]
    public async Task UpdateUltimateGoalInformation_InvalidData_ReturnsFailureWithErrorMessage()
    {
        // Arrange
        var random = new Faker().Random;
        var fakeUserId = random.Guid();
        ...
        var invalidName = "";
        var command = new UpdateUltimateGoalInformationCommand(fakeUltimateGoalId, invalidName);
        var handler = new UpdateUltimateGoalInformationCommandHandler(context);
